...
class ArmoryExamplesBrowser {
	static main() {
		window.addEventListener("load",function(e) {
			...
			let build = { os : "Windows", commit : "f9b2e6c92617caaed06cb08c2de9e3c230527cb3", time : "2022-03-17"};
