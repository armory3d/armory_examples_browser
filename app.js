...
class ArmoryExamplesBrowser {
		...
		window.addEventListener("load",function(e) {
			...
			window.onkeydown = function(e) {
				...
				case "f":
					...
					break;
				case "o":
					console.log("src/ArmoryExamplesBrowser.hx:137:","OPEN PROJECT");
					break;
				case "r":
	...
	static addProjectGroup(group,projects) {
		...
		link.href = "" + ArmoryExamplesBrowser.REPO_OWNER + "/armory_" + group;
		...
		while(_g < projects.length) {
			...
			src.href = src.title = "" + ArmoryExamplesBrowser.REPO_OWNER + "/armory_" + group + "/tree/master/" + project;
			controls.append(src);
		}
...
ArmoryExamplesBrowser.REPO_OWNER = "https://github.com/armory3d";
